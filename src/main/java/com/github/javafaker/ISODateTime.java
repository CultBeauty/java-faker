...
public class ISODateTime {
    ...
    ISODateTime(Faker faker) {
        this(new DateTimeGetter(Clock.systemDefaultZone()), faker);
    }

    ISODateTime(DateTimeGetter dateTimeGetter, Faker faker) {
    ...
    public ZonedDateTime between(ZonedDateTime from, ZonedDateTime to) throws IllegalArgumentException {
        ...
        final long offsetMillis = faker.random().nextLong(intervalMillis);
